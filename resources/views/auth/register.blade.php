    ...
    <div class="min-h-screen flex justify-center items-center p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 max-w-5xl w-full mx-auto gap-x-10 items-center">
            ...
            <div class="bg-white p-10 rounded-2xl shadow-md">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex flex-col gap-y-7">
                        ...
                        {{-- NAME --}}
                        <div>
                            <p class="font-semibold text-indigo-950 text-base mb-2">Full Name</p>
                        ...
                        {{-- CONFIRM PASSWORD --}}
                        <div>
                            <p class="font-semibold text-indigo-950 text-base mb-2">Confirm Password</p>
            ...
            <div class="hidden lg:block">
                <img src="{{ asset('images/hero_illustration.png') }}" alt="Register Illustration">
            </div>

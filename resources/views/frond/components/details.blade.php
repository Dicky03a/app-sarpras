...
<section
      ...
      <div class="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-5 md:p-[30px] gap-6 md:gap-[30px] bg-white">
            ...
            {{-- ASSET PHOTO --}}
            <div class="w-full h-[300px] md:h-[400px] rounded-2xl overflow-hidden bg-gray-100">
                  @if($asset->photo)
                  <img
                  ...
                  <div class="w-full h-full flex flex-col items-center justify-center text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20 h-20 mb-3">

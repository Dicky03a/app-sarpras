<div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
  ...
  <!-- Light Badge-->
  <span
    class="inline-flex items-center justify-center gap-1 rounded-full bg-gray-400 px-2.5 py-0.5 text-sm font-medium text-white"
  >
    Light
  </span>
  ...
  <!-- Dark Badge-->
  <span
    class="inline-flex items-center justify-center gap-1 rounded-full bg-gray-800 px-2.5 py-0.5 text-sm font-medium text-white"
  >
    Dark
  </span>
</div>

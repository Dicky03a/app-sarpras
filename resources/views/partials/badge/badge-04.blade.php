<div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
  ...
  <!-- Light Badge-->
  <span
    class="inline-flex items-center justify-center gap-1 rounded-full bg-gray-400 py-0.5 pl-2 pr-2.5 text-sm font-medium text-white"
  >
    <svg
      class="fill-current"
      width="12"
  ...
  <!-- Dark Badge-->
  <span
    class="inline-flex items-center justify-center gap-1 rounded-full bg-gray-800 py-0.5 pl-2 pr-2.5 text-sm font-medium text-white"
  >
    <svg
      class="fill-current"
      width="12"

<div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
  ...
  <!-- Light Badge-->
  <span
    class="inline-flex items-center justify-center gap-1 rounded-full bg-gray-400 py-0.5 pl-2.5 pr-2 text-sm font-medium text-white"
  >
    Light
  ...
  <!-- Dark Badge-->
  <span
    class="inline-flex items-center justify-center gap-1 rounded-full bg-gray-800 py-0.5 pl-2.5 pr-2 text-sm font-medium text-white"
  >
    Dark

...
>
      ...
      <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div class="relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-[42px] pr-3.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 xl:w-[300px]"
          />
        </div>
  ...
  <div class="border-t border-gray-100 p-4 sm:p-6">
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3">
      <!-- Media item-->
      <div
        class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 xl:pr-5"
      >
        ...
        <div>
          <span
            class="mb-1 block text-right text-sm text-gray-500"
          >
            245 files
          </span>
          <span
            class="block text-right text-sm text-gray-500"
          >
            26.40 GB
          </span>
        </div>

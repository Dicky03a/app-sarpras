<div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
  <!-- Card item -->
  <div
    class="rounded-2xl border border-gray-200 bg-white p-4 md:p-6"
  >
    ...
    <div class="my-6">
      ...
      >
        ...
        <span class="text-right text-theme-sm text-gray-500">
          4.7K
        </span>
      </div>
    ...
    <a
      href="#"
      class="flex justify-center gap-2 rounded-lg border border-gray-300 bg-white p-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50"
    >
      Channels Report
      <svg
        class="fill-current"
  ...
  >
    ...
    <a
      href="#"
      class="flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white p-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50"
    >
      Channels Report
      <svg
        class="fill-current"

    ...
    <div class="min-w-[500px]">
      <div class="flex flex-col gap-2">
        <div
          ...
          class="flex cursor-pointer items-center gap-9 rounded-lg p-3 hover:bg-gray-50"
        >
          <div class="flex items-start gap-3">
            <div
              class="flex h-5 w-5 items-center justify-center rounded-md border-[1.25px]"
              :class="checked ? 'border-brand-500 bg-brand-500' : 'bg-white border-gray-300' "
            >
              <svg
            ...
            <div>
              <span
                class="mb-0.5 block text-theme-xs text-gray-500"
              >
                Wed, 11 jan
              </span>
              <span
                class="text-theme-sm font-medium text-gray-700"
              >
                09:20 AM
              </span>
            </div>
          ...
          <div>
            <span
              class="mb-1 block text-theme-sm font-medium text-gray-700"
            >

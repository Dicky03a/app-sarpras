...
>
  ...
  <div class="flex h-[372px] flex-col">
    <div class="custom-scrollbar flex h-auto flex-col overflow-y-auto pr-3">
      <!-- Watchlist item -->
      <div
        class="flex items-center justify-between border-b border-gray-200 pb-4 pt-4 first:pt-0 last:border-b-0 last:pb-0"
      >
        ...
        <div>
          <div>
            <h4
              class="mb-1 text-right text-theme-sm font-medium text-gray-700"
            >
              $4,008.65
            </h4>
          </div>
          ...
          <span
            class="flex items-center justify-end gap-1 text-theme-xs font-medium text-success-600"
          >
            <svg
              class="fill-current"
              width="12"
      ...
      >
        ...
        <div>
          ...
          <span
            class="flex items-center justify-end gap-1 text-theme-xs font-medium text-error-600"
          >
            <svg
              class="fill-current"
              width="12"
      ...
      >
        ...
        <div>
          <div>
            <h4
              class="mb-1 text-right text-theme-sm font-medium text-gray-600"
            >
              $13,895.00
            </h4>
          </div>
          ...
          <span
            class="flex items-center justify-end gap-1 text-theme-xs font-medium text-success-700"
          >
            <svg
              class="fill-current"
              width="12"

...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-2">Report Damage</h3>
            <p class="text-gray-600 dark:text-gray-300">Report asset damages</p>
            <a href="{{ route('reportdamages.create') }}" class="text-blue-600 hover:text-blue-800 font-medium">Report Damage</a>
        </div>
    </div>
</div>
@endsection